...
def get_args_parser():
    ...
    parser.add_argument('--coco_path', default="XX/COCO")
    parser.add_argument('--remove_difficult', action='store_true')
    parser.add_argument('--fix_size', action='store_true', 
                        help="Using for debug only. It will fix the size of input images to the maximum.")

    # Traing utils
    parser.add_argument('--output_dir', default='XX/output', help='path where to save, empty for no saving')
    parser.add_argument('--note', default='', help='add some notes to the experiment')
    parser.add_argument('--device', default='cuda', help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--resume', default='', help='resume from checkpoint')# resume
...
def main(args):
    ...
    logger.info('number of trainable params:'+str(n_parameters_train)) 
    ...
    if args.eval:
        ...
        test_stats, coco_evaluator = evaluate(model, criterion, postprocessors,
                                              data_loader_val, base_ds, device, args.output_dir, wo_class_error=wo_class_error, args=args,logger=logger)
        ...
        if args.output_dir and utils.is_main_process():
            ...
            if coco_evaluator is not None:
                ...
                if "bbox" in coco_evaluator.coco_eval:
                    ...
                    if epoch % 50 == 0:
                        filenames.append(f'{epoch:03}.pth') # every 50 epoch
